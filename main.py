...
class User(db.Model, UserMixin):
    ...
    # Patent relationship with BlogPost model
    # This will act like a List of BlogPost objects attached to each User.
    # The "author" refers to the author property in the BlogPost class.
    posts = relationship("BlogPost", back_populates="author")

    # Patent relationship with Comment model
...
class BlogPost(db.Model):
    ...
    # Child relationship with Users model
    ...
    # Parent Relationship with comments model
...
class Comment(db.Model):
    ...
    # Child relationship with BlogPost model
...
def admin_only(func):
    ...
    # hence we change the wrapper name
...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        password = check_password_hash(user.password, password=login_form.password.data)
        if not user and not password:
            flash("This email has not been used to sign up yet. Please register.")
